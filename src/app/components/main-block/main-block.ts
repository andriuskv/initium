...
@Component({
    ...
    template: `
        <div class="main-block"
            ...
            <ul class="main-block-nav" [class.hidden]="isNavHidden">
                <li class="main-block-nav-item">
                    <button class="btn-secondary main-block-nav-item-btn" (click)="selectTab('topSites')" title="Top sites">
                ...
                <li class="main-block-nav-item">
                    <button class="btn-secondary main-block-nav-item-btn" (click)="selectTab('notepad')" title="Notepad">
                        <svg viewBox="0 0 24 24">
                ...
                <li class="main-block-nav-item">
                    <button class="btn-secondary main-block-nav-item-btn"

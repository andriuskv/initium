...
test("should get hours offset", () => {
  const offset1 = getHoursOffset(0);
  const offset2 = getHoursOffset(1000 * 60 * 60 * 2);
  const offset3 = getHoursOffset(-1000 * 60 * 60 * 2);

  const offset6 = getHoursOffset(0, true);
  const offset7 = getHoursOffset(1000 * 60 * 60 * 2, true);
  const offset8 = getHoursOffset(-1000 * 60 * 60 * 2, true);

  expect(offset1).toBe("Current timezone");
  expect(offset2).toBe("2 hours ahead");
  expect(offset3).toBe("2 hours behind");
